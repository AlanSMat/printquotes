...
class DD_Data
{
  ...
  public function data()
  {
    ...
    $vars[2] = "db_table";
    $vars[3] = "db_id";
    $vars[4] = "db_list_column";
    $vars[5] = "db_foreign_key";
...
class Dropdowns extends DD_Data
{
  ...
  {  	
    ...
    ?>
	addListGroup("<?php echo $this->list_group ?>", "<?php echo $this->_level_one_list["db_table"] ?>"); addOption("<?php echo $this->_level_one_list["db_table"] ?>", " -- select company -- ", "", "", 1); //Empty starter option
    <?php
    ...
    {
      $list_name = strtolower(ereg_replace(" ", "_", $row["". $this->_level_one_list["db_list_column"] . ""]));
